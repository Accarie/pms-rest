        ...
        return (
          <div className="flex gap-2">
            <button
              ...
              className="bg-black text-white px-4 py-2 rounded-md transition-colors duration-300 hover:bg-primary-black shadow-md"
            >
              View
            </button>
            ...
            <div className="w-full justify-end sm:justify-between flex mb-6 items-center">
              <div>
                ...
                <div className="flex items-center justify-center space-x-6 mt-8">
                  <button
                    className="bg-black text-white rounded-lg py-3 px-8 text-lg font-semibold transition-colors duration-300 hover:bg-primary-black shadow-md"
              ...
              <div className="bg-white w-11/12 dsm:w-10/12 sm:w-5/12 plg:w-3/12 rounded-3xl flex items-center relative h-12 justify-between">
                ...
                <button
                  ...
                  className="absolute top-1 mx-auto bottom-1 right-2 bg-black w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-300 hover:bg-primary-black shadow-md"
