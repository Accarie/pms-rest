        ...
        return (
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-black hover:bg-primary-black text-white rounded-md text-sm transition"
            >
              View
            </button>
          ...
          <div className="w-full my-14">
            <div className="w-full justify-end sm:justify-between flex mb-6 items-center">
              <div>
                ...
                {role != "ADMIN" && (
                  <button
                    className="text-white bg-black rounded py-2 px-8 text-lg"
              ...
              <div className="bg-white w-11/12 dsm:w-10/12 sm:w-5/12 plg:w-3/12 rounded-3xl flex items-center relative h-12 justify-between">
                ...
                <button
                  ...
                  className="absolute top-1 mx-auto bottom-1 right-2 bg-black w-10 h-10 rounded-full flex items-center justify-center"
                >
