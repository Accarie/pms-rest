      ...
      render: (row) => (
        <div className="flex gap-3">
          <button
            ...
            className="bg-black hover:bg-black focus:ring-2 focus:bg-primary-black focus:outline-none text-white px-4 py-1.5 rounded-md shadow-md transition duration-200 ease-in-out text-sm font-semibold"
          >
            View
          </button>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-10">
              ...
              <div className="flex flex-row gap-10">
                ...
                <button
                  ...
                  className="bg-black hover:bg-primary-black text-white px-6 py-2 text-base rounded-lg shadow-md transition-all"
                >
                  Enter Parking
                </button>
              </div>
              ...
              <div className="relative w-full sm:w-1/2 md:w-1/3">
                <input
                  ...
                  className="w-full bg-white border border-gray-300 rounded-full py-2 pl-5 pr-12 shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-black"
                />
                <button
                  onClick={() =>
                    getSessions({
                  ...
                  className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-black hover:bg-primary-black w-9 h-9 rounded-full flex items-center justify-center"
                >
