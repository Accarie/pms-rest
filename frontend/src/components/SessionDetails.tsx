    ...
    <div className="mt-6 flex justify-end gap-3">
      ...
      {showExitButton && (
        <button
          ...
          className="px-5 py-2 rounded-lg bg-black hover:bg-black text-white text-sm font-medium transition"
        >
          Exit Now
        </button>
      )}
