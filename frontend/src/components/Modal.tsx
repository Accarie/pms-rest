        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full rounded-lg border px-4 py-2 text-sm sm:text-base transition focus:outline-none focus:ring-2 focus:ring-black ${
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className={`flex items-center justify-center gap-2 bg-black hover:bg-black text-white px-5 py-2 rounded-lg text-sm sm:text-base font-medium transition ${
